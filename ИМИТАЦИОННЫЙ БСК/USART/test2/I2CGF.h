...
#define I2C_PORT	PORTD	// Тут указать порт, например PORTB или PORTC
#define I2C_PIN		PIND	// Тут указать порт, например PINB или PINC
#define I2C_DDR		DDRD	// Тут указать порт, например DDRB или DDRC
